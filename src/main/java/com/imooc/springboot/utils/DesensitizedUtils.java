...
import com.imooc.springboot.entity.UserEntity;
...
public class DesensitizedUtils {
    ...
    public static void main(String[] args) {
        ...
        userEntity.setChineseName("张无忌");
        userEntity.setIdCard("413026199801100014");
        userEntity.setMobileNumber("17633720773");
        userEntity.setPassword("123456");

        String json = DesensitizedUtils.getJson(userEntity);
